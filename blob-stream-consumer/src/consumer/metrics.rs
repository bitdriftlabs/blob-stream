...
pub(in crate::consumer) struct ConsumerReaderMetrics {
  ...
  fallback_blob_range_requests: IntCounter,
  fallback_blob_range_bytes: IntCounter,
  fallback_blob_range_latency_seconds: Histogram,
  broker_blob_range_requests: IntCounter,
  broker_blob_range_successes: IntCounter,
  broker_blob_range_bytes: IntCounter,
...
impl ConsumerReaderMetrics {
  pub(in crate::consumer) fn new(scope: &Scope) -> Self {
    ...
    Self {
      ...
      fallback_blob_range_requests: scope.counter("fallback_blob_range_requests"),
      fallback_blob_range_bytes: scope.counter("fallback_blob_range_bytes"),
      fallback_blob_range_latency_seconds: scope.histogram("fallback_blob_range_latency_seconds"),
      broker_blob_range_requests: scope.counter("broker_blob_range_requests"),
      broker_blob_range_successes: scope.counter("broker_blob_range_successes"),
      broker_blob_range_bytes: scope.counter("broker_blob_range_bytes"),
  ...
  pub(in crate::consumer) fn record_fallback_blob_range_success(
    ...
    self
      .fallback_blob_range_latency_seconds
      .observe(started_at.elapsed().as_secs_f64());
  }

  pub(in crate::consumer) fn record_broker_blob_range_request(&self) {
    self.broker_blob_range_requests.inc();
  }

  pub(in crate::consumer) fn record_broker_blob_range_success(
    &self,
    started_at: Instant,
    bytes: u64,
  ) {
    self.broker_blob_range_successes.inc();
    self.broker_blob_range_bytes.inc_by(bytes);
    self
      .broker_blob_range_latency_seconds
      .observe(started_at.elapsed().as_secs_f64());
  }

  pub(in crate::consumer) fn record_broker_blob_range_not_found(&self) {
