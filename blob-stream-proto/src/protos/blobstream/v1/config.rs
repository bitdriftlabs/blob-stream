...
pub struct BrokerConfig {
    ...
    // @@protoc_insertion_point(field:blobstream.v1.BrokerConfig.adaptive_flush_max_delay_enabled)
...
impl BrokerConfig {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "adaptive_flush_max_delay_enabled",
            |m: &BrokerConfig| { &m.adaptive_flush_max_delay_enabled },
            |m: &mut BrokerConfig| { &mut m.adaptive_flush_max_delay_enabled },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, ::protobuf::well_known_types::duration::Duration>(
...
impl ::protobuf::Message for BrokerConfig {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                144 => {
                    self.adaptive_flush_max_delay_enabled = ::std::option::Option::Some(is.read_bool()?);
                },
                154 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.adaptive_flush_max_delay_enabled {
            my_size += 2 + 1;
        }
...
// @@protoc_insertion_point(message:blobstream.v1.EventualMetadataReadsConfig)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct EventualMetadataReadsConfig {
    // message fields
    // @@protoc_insertion_point(field:blobstream.v1.EventualMetadataReadsConfig.visibility_delay)
    pub visibility_delay: ::protobuf::MessageField<::protobuf::well_known_types::duration::Duration>,
    // special fields
    // @@protoc_insertion_point(special_field:blobstream.v1.EventualMetadataReadsConfig.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a EventualMetadataReadsConfig {
    fn default() -> &'a EventualMetadataReadsConfig {
        <EventualMetadataReadsConfig as ::protobuf::Message>::default_instance()
    }
}

impl EventualMetadataReadsConfig {
    pub fn new() -> EventualMetadataReadsConfig {
        ::std::default::Default::default()
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, ::protobuf::well_known_types::duration::Duration>(
            "visibility_delay",
            |m: &EventualMetadataReadsConfig| { &m.visibility_delay },
            |m: &mut EventualMetadataReadsConfig| { &mut m.visibility_delay },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<EventualMetadataReadsConfig>(
...
impl ::protobuf::Message for EventualMetadataReadsConfig {
    const NAME: &'static str = "EventualMetadataReadsConfig";
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.visibility_delay)?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.visibility_delay.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
    ...
    fn new() -> EventualMetadataReadsConfig {
        EventualMetadataReadsConfig::new()
    }

    fn clear(&mut self) {
        self.visibility_delay.clear();
        self.special_fields.clear();
    }

    fn default_instance() -> &'static EventualMetadataReadsConfig {
        static instance: EventualMetadataReadsConfig = EventualMetadataReadsConfig {
            visibility_delay: ::protobuf::MessageField::none(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
impl ::protobuf::MessageFull for EventualMetadataReadsConfig {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("EventualMetadataReadsConfig").unwrap()).clone()
    }
}

impl ::std::fmt::Display for EventualMetadataReadsConfig {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for EventualMetadataReadsConfig {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}
...
pub struct ConsumerReadConfig {
    ...
    // @@protoc_insertion_point(field:blobstream.v1.ConsumerReadConfig.eventual_metadata_reads)
    pub eventual_metadata_reads: ::protobuf::MessageField<EventualMetadataReadsConfig>,
...
impl ConsumerReadConfig {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, EventualMetadataReadsConfig>(
            "eventual_metadata_reads",
            |m: &ConsumerReadConfig| { &m.eventual_metadata_reads },
            |m: &mut ConsumerReadConfig| { &mut m.eventual_metadata_reads },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
...
impl ::protobuf::Message for ConsumerReadConfig {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                74 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.eventual_metadata_reads)?;
                },
                80 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.eventual_metadata_reads.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    CacheRequestTimeoutB\x08\xfaB\x05\xaa\x01\x02*\0\x12K\n\x20adaptive_flus\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(EventualMetadataReadsConfig::generated_message_descriptor_data());
