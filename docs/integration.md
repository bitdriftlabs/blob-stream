...
Feature flags are optional at construction time. When configured, consumer flags can override
strong metadata reads, prefetch capacity, and batch-read concurrency. See [Infrastructure
setup](infrastructure.md) and [Operations](operations.md) for deployment and consistency effects.
